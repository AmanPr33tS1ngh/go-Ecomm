...
var (
	CantFindProductErr = errors.New("")
	CantDecodeProductErr = errors.New("")
	UserIdNotValidErr = errors.New("")
	CantUpdateUserErr = errors.New("")
	CantRemoveItemErr = errors.New("")
	CantGetItemErr = errors.New("")
	CantBuyCartItemErr = errors.New("")
)
...
func AddToCart(ctx context.Context, prodCollection, userCollection *mongo.Collection, productID primitive.ObjectID, userID string) error {
	...
	if err != nil {
		log.Println(err)
		return CantFindProductErr
	}
	var productcart []models.ProductUser
	err = searchfromdb.All(ctx, &productcart)
	if err != nil {
		log.Println(err)
		return CantDecodeProductErr
	}

	id, err := primitive.ObjectIDFromHex(userID)
	if err != nil {
		log.Println(err)
		return UserIdNotValidErr
	}
